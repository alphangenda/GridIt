...
namespace Persistence.Migrations
{
    ...
    [Migration("20260414171438_AddProgramSkills")]
    partial class AddProgramSkills
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Classes.Class", b =>
                {
                    ...
                    b.HasIndex("ProgramId")
                        .HasDatabaseName("ix_classes_program_id");

                    b.ToTable("classes", (string)null);
                });

            modelBuilder.Entity("Domain.Entities.Classes.CourseProgram", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_course_programs");

                    b.ToTable("course_programs", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.Classes.Group", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Domain.Entities.Classes.GroupClass", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("ClassId")
                        .HasDatabaseName("ix_group_classes_class_id");
            ...
            modelBuilder.Entity("Domain.Entities.Classes.Class", b =>
                {
                    b.HasOne("Domain.Entities.Classes.CourseProgram", "Program")
                        .WithMany()
                        .HasForeignKey("ProgramId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_classes_course_programs_program_id");
            ...
            modelBuilder.Entity("Domain.Entities.Classes.Exam", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Classes.Group", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Entities.Classes.GroupClass", b =>
                {
                    b.HasOne("Domain.Entities.Classes.Class", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_group_classes_classes_class_id");
