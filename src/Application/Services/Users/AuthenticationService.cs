...
public class AuthenticationService : IAuthenticationService
{
    ...
    public bool IsTeacherFromPublicCegep(User user)
    {
        ...
        var cegepTeacherEmailRegexes = new[]
        {
            ...
            @"^[a-zA-Z0-9._%+-]+@cegepgarneau\.ca$",         // C�gep Garneau (profs = domaine sans "edu.")
            @"^[a-zA-Z0-9._%+-]+@cegep-limoilou\.qc\.ca$",   // C�gep Limoilou (� confirmer)
            @"^[a-zA-Z0-9._%+-]+@slc\.qc\.ca$"               // C�gep St-Lawrence (� confirmer)
        };
