    ...
    <div class="popup" role="dialog" aria-modal="true">
      ...
      <div class="popup__container">
        <div class="popup__header">
          <p class="popup__title h2-like">{{ t("pages.programs.skillRemoveTitle") }}</p>
        </div>
        <div class="popup__content">
          <div class="popup__block confirm-remove">
            <p class="confirm-remove__text">
              {{ t("pages.programs.skillRemoveConfirm", { name: skillLabel }) }}
            </p>
