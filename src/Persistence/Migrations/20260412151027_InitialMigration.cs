        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    last_two_factor_authentication = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    phone_extension = table.Column<int>(type: "integer", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_session_classes", x => x.id);
                    table.ForeignKey(
                        name: "fk_session_classes_classes_class_id",
                        column: x => x.class_id,
                        principalTable: "classes",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "fk_session_classes_sessions_session_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_exam_skills_exams_exam_id",
                        column: x => x.exam_id,
                        principalTable: "exams",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "fk_exam_skills_skills_skill_id",
                        column: x => x.skill_id,
            ...
            migrationBuilder.CreateIndex(
                name: "ix_exam_skills_exam_id",
                table: "exam_skills",
                column: "exam_id");

            migrationBuilder.CreateIndex(
                name: "ix_exam_skills_skill_id",
                table: "exam_skills",
                column: "skill_id");
            ...
            migrationBuilder.CreateIndex(
                name: "ix_session_classes_class_id",
                table: "session_classes",
                column: "class_id");

            migrationBuilder.CreateIndex(
                name: "ix_session_classes_session_id",
                table: "session_classes",
                column: "session_id");
