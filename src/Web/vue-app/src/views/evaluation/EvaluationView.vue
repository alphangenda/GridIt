...
<style>
[data-theme="dark"] .grid-th {
  border-color: rgba(255, 255, 255, 0.08);
  background-color: #2d2d44;
  color: rgba(255, 255, 255, 0.85);
}

[data-theme="dark"] .grid-td {
  border-color: rgba(255, 255, 255, 0.07);
  color: rgba(255, 255, 255, 0.85);
  background-color: #2d2d44;
}

[data-theme="dark"] .grid-td--note {
...
[data-theme="dark"] .grade-cell:hover:not(.grade-cell--disabled):not(.grade-cell--summary) {
  background-color: rgba(255, 255, 255, 0.08);
}

[data-theme="dark"] .grade-cell--disabled {
  background-color: rgba(255, 255, 255, 0.02);
  color: rgba(255, 255, 255, 0.2);
}

[data-theme="dark"] .grid-competency-note-row td {
  background-color: #2d2d44;
  color: rgba(255, 255, 255, 0.85);
}

[data-theme="dark"] .evaluation__criterion-comment-input,
[data-theme="dark"] .evaluation__comment-input {
  background-color: rgba(255, 255, 255, 0.05);
  border-color: rgba(255, 255, 255, 0.1);
  color: rgba(255, 255, 255, 0.85);
}

[data-theme="dark"] .evaluation__video-url {
  background-color: rgba(255, 255, 255, 0.04);
  border-color: rgba(255, 255, 255, 0.08);
}

[data-theme="dark"] .evaluation__video-url-label {
  color: rgba(255, 255, 255, 0.6);
}

[data-theme="dark"] .evaluation__video-url-input {
  background-color: #2d2d44;
  border-color: rgba(255, 255, 255, 0.1);
  color: rgba(255, 255, 255, 0.85);
}
